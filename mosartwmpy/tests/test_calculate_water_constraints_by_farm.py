...
class CalculateWaterConstraintsByFarmTest(unittest.TestCase):
    ...
    OUTPUT_PATH = str(importlib.resources.files('mosartwmpy').joinpath('tests'))
    ...
    DEPENDENCY_FILE = str(importlib.resources.files('mosartwmpy').joinpath('tests', 'dependency_database.parquet'))
    MEAN_FLOW_FILE = str(importlib.resources.files('mosartwmpy').joinpath('tests', 'mean_flow.parquet'))
    MEAN_DEMAND_FILE = str(importlib.resources.files('mosartwmpy').joinpath('tests', 'mean_demand.parquet'))
    CONSTRAINTS_FILE = str(importlib.resources.files('mosartwmpy').joinpath('tests', 'test_land_water_constraints_by_farm.parquet'))
    LIVE_FILE = str(importlib.resources.files('mosartwmpy').joinpath('tests', 'test_land_water_constraints_by_farm_live.parquet'))
    BIAS_FILE = str(importlib.resources.files('mosartwmpy').joinpath('tests', 'test_historic_storage_supply_bias.parquet'))
    CROP_FILE = str(importlib.resources.files('mosartwmpy').joinpath('tests', 'test_crop_prices_by_nldas_id.parquet'))

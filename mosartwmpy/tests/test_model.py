...
class ModelTest(unittest.TestCase):
    ...
    def test_input_io(self):
        ...
        single_index_position = np.full(1, np.nonzero(self.model.mask == True)[0][0])
        ...
        np.testing.assert_array_equal(full_destination[self.model.mask], full_value[self.model.mask], "model can get and set input")
        np.testing.assert_array_equal(pointer[self.model.mask], full_value[self.model.mask], "model can get pointer for input variable")
    ...
    def test_output_io(self):
        ...
        np.testing.assert_array_equal(full_destination[self.model.mask], full_value[self.model.mask], "model can get and set output")
        np.testing.assert_array_equal(pointer[self.model.mask], full_value[self.model.mask], "model can get pointer for output variable")
